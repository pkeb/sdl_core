set(GSTREAMER_gst_INCLUDE_DIR ${CMAKE_SYSROOT}/usr/include/gstreamer-1.0/gst/)
set(GSTREAMER_gst_INCLUDE_DIR ${CMAKE_SYSROOT}/usr/include/gstreamer-1.0/ ${GSTREAMER_gst_INCLUDE_DIR})
set(GSTREAMER_gstconfig_INCLUDE_DIR ${CMAKE_SYSROOT}/usr/include/gstreamer-1.0/)
set(GSTREAMER_gstaudio_LIBRARY ${CMAKE_SYSROOT}/usr/lib/libgstaudio-1.0.so)
set(GSTREAMER_gstapp_LIBRARY ${CMAKE_SYSROOT}/usr/lib/libgstapp-1.0.so)
set(GSTREAMER_gstbase_LIBRARY ${CMAKE_SYSROOT}/usr/lib/libgstbase-1.0.so)
# libgstcdda-1.0 is missing
set(GLIB_gstcdda_LIBRARY ${CMAKE_SYSROOT}/usr/lib/libgstcontroller-1.0.so)
# libgstdataprotocol-1.0 is missing
# libgstinterfaces-1.0 is missing
set(GSTREAMER_gstnet_LIBRARY ${CMAKE_SYSROOT}/usr/lib/libgstnet-1.0.so
# libgstnetbuffer-1.0 is missing
set(GSTREAMER_gstpbutils_LIBRARY ${CMAKE_SYSROOT}/usr/lib/libgstpbutils-1.0.so)
set(GSTREAMER_gstreamer_LIBRARY ${CMAKE_SYSROOT}/usr/lib/libgstreamer-1.0.so)
set(GSTREAMER_gstriff_LIBRARY ${CMAKE_SYSROOT}/usr/lib/libgstriff-1.0.so)
set(GSTREAMER_gstrtp_LIBRARY ${CMAKE_SYSROOT}/usr/lib/libgstrtp-1.0.so)
set(GSTREAMER_gstrtsp_LIBRARY ${CMAKE_SYSROOT}/usr/lib/libgstrtsp-1.0.so)
set(GSTREAMER_gstsdp_LIBRARY ${CMAKE_SYSROOT}/usr/lib/libgstsdp-1.0.so)
set(GSTREAMER_gsttag_LIBRARY ${CMAKE_SYSROOT}/usr/lib/libgsttag-1.0.so)
set(GSTREAMER_gstvideo_LIBRARY ${CMAKE_SYSROOT}/usr/lib/libgstvideo-1.0.so)
